...
describe('POST /v1/render', () => {
  ...
  beforeAll(async () => {
      server = (await createServer(false)).listen(3000)
  })
...
describe('POST /v1/render (minify=true)', () => {
  ...
  beforeAll(async () => {
      server = (await createServer(true)).listen(3000)
  })
